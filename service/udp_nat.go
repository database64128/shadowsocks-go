...
func (s *UDPNATRelay) startGeneric(index int, lnc *udpRelayServerConn) (err error) {
...
func (s *UDPNATRelay) recvFromServerConnGeneric(index int, lnc *udpRelayServerConn) {
